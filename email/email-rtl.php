...
*/
    ...
    $email_data['SmallSuitcaseNum'] = number_format($email_data['SmallSuitcaseNum'], 0);
    

     $smallbags = get_custom_field_v1(26,'search_ticket_0_small_bags');    
     $bigbags = get_custom_field_v1(26,'search_ticket_0_big_bags');   
    

    if($email_data['IsAirconditioning']){
        $features[] = get_field('email_air_conditioning_herbrew', 'options');
    }
    if($email_data['IsAutomatic']){
        $features[] = get_field('email_automatic_transmission_herbrew', 'options');
    }
    if($email_data['IsManual']){
        $features[] = get_field('email_manual_transmission_herbrew', 'options');
    }
      ...
      $email_data['AgeRange'] = $email_data['Age'];
            ...
            plugin_log844C('email-rtl.php 44');
            plugin_log844C($email_data);
?>
<!DOCTYPE html>
...
<body class="email" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;color: #333;margin: 0;font-size: 14px;line-height: 1.42857143;background-color: #f4f6f7;background: white; direction: rtl;">
    ...
    <div class="email-container" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;max-width: 600px;margin-left: auto;margin-right: auto;position: relative;">
        <div class="email-info" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;">
            ...
            <!-- 8.40: adding agent Name  -->

            <?php if (isset($email_data['AgentName'])): ?>
             <h1 class="email-info__recipement" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: inherit;color: #e8503e;margin: .67em 0;font-size: 24px;font-weight: 500;line-height: 1.1;margin-top: 20px;margin-bottom: 10px;">
            <?php echo $email_data['AgentName']; ?>,
            </h1>
            <?php endif; ?>


            <h1 class="email-info__recipement" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: inherit;color: #e8503e;margin: .67em 0;font-size: 18px;font-weight: 500;line-height: 1.1;margin-top: 20px;margin-bottom: 10px;"><?php echo get_field('email_dear_mr_hebrew', 'options'); ?> <?php echo $email_data['first_name'] . ' ' . $email_data['last_name'].' ( '.$email_data['phone'].' '.$email_data['email'].' )' ?>,
            </h1>
            ...
            <div class="email-info__thanks additional_text" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;padding-top: 33px;padding-left: 2px;">
                <p class="additional_text__thanks" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;"><?php echo get_field('thank_you_for_hebrew', 'options'); ?></p>
                <p class="additional_text__request" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-top: 4px;"><?php echo get_field('email_reservation_request_hebrew', 'options'); ?></p>
            </div>
            ...
            <div class="email-info__rental-details email-details-table" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;border: 1px solid #d4dadd;margin-top: 20px;">
                <h1 class="email-details-table__title" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: inherit;color: #000000;margin: 0;font-size: 18px;font-weight: 500;line-height: 1.1;margin-top: 0px;margin-bottom: 10px;text-align: center;background-color: #d4dadd;padding-top: 5px;padding-bottom: 10px;"><?php echo get_field('email_rental_details_hebrew', 'options'); ?></h1>
                ...
                <div class="table-content__bottom" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;padding-left: 26px;padding-top: 13px;padding-right: 26px;padding-bottom: 14px;">
                    <div class="table-content__bottom-block" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;">
                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;">גיל הנהג: <?php echo $email_data['AgeRange']?></p>
                        <p class="table-content__block--line " id="VehicleType" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo get_field('email_car_type_hebrew', 'options'); ?> <?php echo $email_data['CarTypeDesc'] ?> <span class="table-content__block--bold" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;font-weight: 600;"><?php echo $email_data['GROUPNAME']  ?> <?php echo get_field('email_or_similar_hebrew', 'options')  ; ?></span></p> 

                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo $email_data['email_seats'] ?> <?php echo get_field('email_seats_hebrew', 'options'); ?> | <?php echo $email_data['DoorsNum'] ?> <?php echo get_field('email_doors_hebrew', 'options'); ?> | <?php echo $email_data['SmallSuitcaseNum']  ?> <?php echo $smallbags;?>
                         | <?php echo $email_data['LargeSuitcaseNum']  ?> <?php echo $bigbags; ?>
                         <!-- electric car note -->
                         | <?php echo GetElectricTxt_V2($email_data['GROUPCODE']) ; ?>
                        </p>
                        ...
                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo get_field('email_fuel_policy_hebrew', 'options'); ?> <?php echo $email_data['FuelPolicyDesc'] ?></p>
                        <?php if($email_data['is_protected'] == 1): ?>
                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo get_field('email_full_protection_hebrew', 'options'); ?></p>
                        <?php endif?>
                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo get_field('email_rates_hebrew', 'options'); ?>
                         <?php echo ($email_data['free_options']) ?></p>
                        <p class="table-content__block--line " style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;padding-bottom: 4px;"><?php echo get_field('email_extra_equip_hebrew', 'options'); ?> <?php echo ($email_data['extra_options'] ?   $email_data['extra_options']: 'ללא') ?></p>
                    </div>
        ...
        <div class="email-footer" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;padding-top: 40px;padding-left: 2px;padding-bottom: 34px;">
            <div class="email-footer__regards" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;border-bottom: 1px solid #d4dadd;padding-bottom: 14px;">
                <p class="email-footer__regards--line" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;font-size: 12px;padding-bottom: 7px;"><?php echo get_field('email_kind_regards_hebrew', 'options'); ?></p>
                <p class="email-footer__regards--line" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: 'Open Sans', sans-serif;color: #010101;orphans: 3;widows: 3;margin: 0;font-size: 12px;padding-bottom: 7px;"><?php echo get_field('email_your_autoshay_hebrew', 'options'); ?></p>
            </div>
